...
export class HnvComponent implements OnInit {
  ...
  steps: Step[] = [
    {
      id: 1,
      name: 'Preparar',
      icon: 'ic_fluent_document_catch_up_20_regular.svg',
      active: true,
    },
    {
      id: 2,
      name: 'Validar',
      icon: 'ic_fluent_checkmark_circle_20_regular.svg',
    },
    {
      id: 3,
      name: 'Analizar',
  ...
  getData(): void {
    ...
    setTimeout(() => {
      this.loading = false;
      this.message =
        'Validación de datos HNV completada. Calidad del conjunto: 98.5%. Última actualización: ' +
        new Date().toLocaleString();

      // Mostrar toast de éxito
      this.toastService.showSuccess('Datos de validación cargados');
    }, 2000);
